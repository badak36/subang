...
echo "                  Progress..."
echo "
echo -e "\e[32;1m_______________________________________\e[0m"
echo -e "\e[104mInstalling TCP BBR...                 \e[0m"
if [ -n "$(lsmod | grep bbr)" ];then
echo -e "\e[104mSuccesfully Installed TCP BBR.\e[0m"
echo -e "\e[32;1m_______________________________________\e[0m"
return 1
fi
...
if [ -n "$(sysctl net.ipv4.tcp_available_congestion_control | grep bbr)" ] && [ -n "$(sysctl net.ipv4.tcp_congestion_control | grep bbr)" ] && [ -n "$(lsmod | grep "tcp_bbr")" ];then
	echo -e "\e[104mTCP BBR Install Success!\e[0m"
else
	echo -e "\e[104mFailed To Install BBR!\e[0m"
fi
echo -e "\e[32;1m_______________________________________\e[0m"
}
...
Optimize_Parameters(){
echo -e "\e[32;1m_______________________________________\e[0m"
echo -e "\e[104mOptimize Parameters...                  \e[0m"
...
echo -e "\e[104mSuccesfully Optimize Parameters.\e[0m"
echo -e "\e[32;1m_______________________________________\e[0m"
}
Install_BBR
Optimize_Parameters
...
sleep 2
echo -e '\e[32;1m_______________________________________\e[0m'
echo -e '\e[104m         Installation Success!          \e[0m'
echo -e '\e[32;1m_______________________________________\e[0m'
sleep 3
#fi
