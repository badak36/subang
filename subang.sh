...
clear;clear;clear
echo -e "${BlueBee}╔════════════════════════════════════════════════╗${NC}"
echo -e "\033[96;1m                SUBANG TUNNELING               \033[0m"
echo -e "${BlueBee}╚════════════════════════════════════════════════╝${NC}"
echo ""
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/badak36/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/badak36/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/badak36/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
clear
REPO="https://raw.githubusercontent.com/badak36/subang/main/"
start=$(date +%s)
secs_to_human() {
...
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/badak36/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/badak36/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
TEXT="
<code>minjem sc nya bang :v<\code>"
...
wget "http://raw.githubusercontent.com/badak36/subang/main/files/limit.sh && chmod +x limit.sh && ./limit.sh"
cd
...
wget https://raw.githubusercontent.com/badak36/subang/main/files/openvpn &&  chmod +x openvpn && ./openvpn
...
wget https://raw.githubusercontent.com/badak36/subang/main/ftr/menu.zip
unzip menu.zip
chmod +x menu/*
...
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96;1m              ----[ SUBANG TUNNELING ]----                    \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
